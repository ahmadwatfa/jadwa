                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="input-group auth-pass-inputgroup "  style="margin-top: 8px">
                                                    <input name="email" type="email"
                                                        ...
                                                        value="{{ old('email') }}" id="email" placeholder="ادخل البريد الالكتروني"
                                                        autocomplete="email">
                                                ...
                                                <div class="mb-3 margin_top_10">
                                                    ...
                                                    <div class="input-group auth-pass-inputgroup @error('password') is-invalid @enderror" style="margin-top: 8px">
                                            ...
                                            <div class="mt-5 text-center yell">
                                                <a id="none">ليس لديك حساب ؟ <a href="{{ url('register') }}" class="fw-medium orange"> حساب جديد</a> </a>
                                            </div>
                                        </div>
                                    </div>
