                    ...
                    <div class="row task-dates">
                        ...
                        <div class="col-sm-3 col-3">
                            <div class="mt-4">
                                ...
                                <p class="text-black mb-0 gray" style="margin-right: 30px;"><?php echo e($project->projectType->title); ?></p>
                            </div>
                        </div>

                        <div class="col-sm-3 col-3">
                            <div class="mt-4">
                                <h5 class="font-size-14 orange"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="currentColor" d="M19 2H9c-1.103 0-2 .897-2 2v6H5c-1.103 0-2 .897-2 2v9a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V4c0-1.103-.897-2-2-2zM5 12h6v8H5v-8zm14 8h-6v-8c0-1.103-.897-2-2-2H9V4h10v16z"/><path fill="currentColor" d="M11 6h2v2h-2zm4 0h2v2h-2zm0 4.031h2V12h-2zM15 14h2v2h-2zm-8 .001h2v2H7z"/></svg></i> الدولة , المدينة
                                </h5>
                                <p class="text-black mb-0 gray" style="margin-right: 10px;"><?php echo e($project->country); ?> | <?php echo e($project->city); ?> </p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3 col-3">
                            <div class="mt-4">
                                ...
                                <p class="text-black mb-0 gray" style="margin-right: 30px;"><?php echo e($project->study_duration); ?> أشهر</p>
                            </div>
                        </div>

                        <div class="col-sm-3 col-3">
                            <div class="mt-4">
                                <h5 class="font-size-14 orange" style="margin-right: 15px;"><i class="bx bx-calendar-check me-1 orange"></i> تاريخ
                                    البداية </h5>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route($services->route, $project->id)); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwacpanl\resources\views/admin/projects/show.blade.php ENDPATH**/ ?>