...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        .select2 span  {height: 36px !important; }
        .select2 span span span  {text-align: right !important }
        #phone{width: 75%;}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <!-- All countries -->
                                    <select id="country" onchange="getCity(this.value)" name="country" class="form-control country">
                                        <option disabled selected value="0">اختر الدولة</option>
                                        <?php $__currentLoopData = DB::select('select * from  countries '); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="city" class="form-label">المدينة</label>
                                     <select id="city" class="form-select city <?php $__errorArgs = ['city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\‏‏jadwa\jadwa\resources\views/admin/users/create.blade.php ENDPATH**/ ?>