                                ...
                                <div class="search-box me-2 mb-2 d-inline-block">
                                    <div class="position-relative">
                                        ...
                                        <input type="text" name="query" class="form-control"
                                            placeholder="ابحث عن انواع المشاريع">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">اضافة  نوع جديد </h5>
                                            ...
                                            <form method="POST" action="projectype/{projectype}" id="editModal">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="title" class="form-control"
                                                        id="title" value="<?php echo e($item->title); ?>" required>
                                                               <?php $__errorArgs = ['tilte'];
    ...
    <script>
        $(function() {
            ...
            $("#newModalForm").validate({
                ...
                messages: {
                    status: "الرجاء قم بتحديد الحالة",
        ...
        $('#editModal').on('show.bs.modal', function(event) {
            ...
            var status = button.data('checked',data.status);
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwacpanl\resources\views/admin/ProjectType/index.blade.php ENDPATH**/ ?>