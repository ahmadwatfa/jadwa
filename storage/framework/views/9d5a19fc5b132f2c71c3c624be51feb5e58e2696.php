                                                ...
                                                <td>
                                                    <div class="d-flex gap-3">
                                                        ...
                                                        <a title="تعديل" class="text-success" data-bs-toggle="modal"
                                                            ...
                                                            data-status="<?php echo e($item->status); ?>" data-bs-target="#editModal">
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-check">
                                                        ...
                                                        <div class="btn-group-horizontal " role="group"
                                                            aria-label="Horizontal radio toggle button group">
                                                            <input type="radio" class="btn-check active" name="status"
                                                                value="active" id="active-radio1">
                                                            <label class="btn btn-outline-success"
                                                                for="active-radio1">نشط</label>
                                                            <input type="radio" class="btn-check inactive"
                                                                name="status" value="inactive" id="active-radio2">
    ...
    <script>
        ...
        $('#editModal').on('show.bs.modal', function(event) {
            ...
            if (status == 'active') {
                ...
                modal.find('.modal-body .inactive').prop("checked", true);
            }

        });
        $('#editModal').click($('active'), function(event) {
            var modal = $(this);
            if ($('.inactive').is( ":checked" )) {
                modal.find('.modal-body .inactive').removeAttr("checked");
                modal.find('.modal-body .active').attr("checked");
            }
        })
        $('#editModal').click($('inactive'), function(event) {
            var modal = $(this);
            if ($('.active').is( ":checked" )) {
                modal.find('.modal-body .active').removeAttr("checked");
                modal.find('.modal-body .inactive').attr("checked");
            }
        })
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwacpanl\resources\views/admin/ProjectType/index.blade.php ENDPATH**/ ?>