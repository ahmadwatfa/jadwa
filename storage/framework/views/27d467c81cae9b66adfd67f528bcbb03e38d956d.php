                            ...
                            <div class="tab-pane fade show active" id="a" role="tabpanel"
                                ...
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label class="col-md-2 ">تويتر</label>
                                                <input type="text" class="form-control" name="twitter"
                                                    placeholder="رابط تويتر"  value="<?php echo e($user->twitter); ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwacpanl\resources\views/admin/users/profile.blade.php ENDPATH**/ ?>