                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">اضافة سلايدر </h5>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="description" class="col-form-label flex">النص التسويقي</label>
                                ...
                                <table class="table align-middle table-nowrap table-check">
                                    <thead class="background">
                                        <tr>
                                            ...
                                            <th class="align-middle"> النص التسويقي </th>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea type="text" class="form-control" name="description" id="description" required><?php echo e(old('description')); ?></textarea>
                                                       <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
        ...
        $(function() {
            ...
            $("#newModalForm").validate({
                ...
                messages: {
                    ...
                    description: "الرجاء قم بادخال النص"
                }
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwacpanl\resources\views/admin/slider/index.blade.php ENDPATH**/ ?>