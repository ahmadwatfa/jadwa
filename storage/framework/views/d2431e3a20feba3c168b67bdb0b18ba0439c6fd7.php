                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <select id="country" name="country" class="form-control country">
                                                <option selected disabled value="<?php echo e($project->countries->id); ?>"><?php echo e($project->countries->name); ?></option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwaportal\resources\views/admin/projects/edit.blade.php ENDPATH**/ ?>