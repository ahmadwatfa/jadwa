    ...
    function getCity(val) {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('select[name="city"]').empty();
                $.each(data.cities, function(key, value) {
                    $('select[name="city"]').append('<option value="' + key + '">' + value +
                        '</option>');
                });
            }
        });
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\my project\jadwaportal\resources\views/admin/users/create.blade.php ENDPATH**/ ?>