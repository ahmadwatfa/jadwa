                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                                                ...
                                                <label for="email" class="form-label colors fon margin_top_10">البريد
                                                    الإلكتروني</label>
                                                <div class="input-group auth-pass-inputgroup "  style="margin-top: 8px">
...
unset($__errorArgs, $__bag); ?>"
                                                        value="<?php echo e(old('email')); ?>" id="email" placeholder="ادخل البريد الالكتروني"
                                                        autocomplete="email">
                                                ...
                                                <div class="mb-3 margin_top_10">
                                                        ...
                                                        <?php if(Route::has('password.request')): ?>
                                                            <a href="<?php echo e(route('password.request')); ?>"
                                                                class="text-muted yell float-end margin_top_10" style="padding-top: 5px;">نسيت كلمة المرور ؟</a>
                                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" style="margin-top: 8px">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <button class="btn btn-light auth_icon" id="show"
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input auth_input" type="checkbox" id="remember"
                                                ...
                                                <div class="mt-3 d-grid">
                                                    <button class="btn btn-primary waves-effect waves-light log auth_shadow auth_button"
                                            ...
                                            <div class="mt-5 text-center yell">
                                                <a id="none">ليس لديك حساب ؟ <a href="<?php echo e(url('register')); ?>" class="fw-medium orange"> حساب جديد</a> </a>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwacpanl\resources\views/auth/login.blade.php ENDPATH**/ ?>