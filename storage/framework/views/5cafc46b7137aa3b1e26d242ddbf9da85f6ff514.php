                                   ...
                                   <form method="POST" action="adminstExp/{adminstExp}" id="editModal">
                                        ...
                                        <input type="hidden" id="id" name="id">
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <input type="text" name="item" class="form-control" id="item" value="<?php echo e($adminstExp->item); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="value" class="form-control" id="value" value="<?php echo e($adminstExp->value); ?>" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jadwacpanl\resources\views/admin/AdminstratorExp/index.blade.php ENDPATH**/ ?>