    ...
    public function get_users()
    {
        ...
        return DataTables::of($user)
            ...
            ->addColumn('action', function ($row) {
                $btn = '';
                $btn = $btn . '&nbsp; <a data-bs-toggle="modal" data-bs-target="#kt_modal_1" title="تأكيد البريد" style="cursor: pointer" data-id="'.$row->id.'" class="text-primary"><i
                class="mdi mdi-email-send font-size-18"></i></a>';
                if($row->status == 'active'){
                $btn = $btn . '&nbsp;<a data-bs-toggle="modal" data-bs-target="#kt_modal_4" title="حظر المستخدم" style="cursor: pointer" data-id="'.$row->id.'" class="text-danger"><i
                                                        class="mdi mdi-toggle-switch-off font-size-20"></i></a>';
                }
                if($row->status == 'inactive'){
                $btn = $btn . '&nbsp;<a data-bs-toggle="modal" data-bs-target="#kt_modal_3" title="نفعيل المستخدم" style="cursor: pointer" data-id="'.$row->id.'" class="text-success"><i
                ...
                $btn = $btn . '&nbsp;<a data-bs-toggle="modal" data-bs-target="#kt_modal_2" title="حذف" style="cursor: pointer" data-id="'.$row->id.'" class="text-danger"><i
